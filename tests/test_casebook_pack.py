"""Regression checks for the meridian-lang-macro-dock casebook."""
...
from casebook.harness import assert_expected, meridian_lang_macro_dock_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(meridian_lang_macro_dock_summary(), assert_expected())
